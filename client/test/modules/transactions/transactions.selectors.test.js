...
import { unassignedTransactionsSelectorFactory, assignedTransactionsSelectorFactory, assignedTransactionsSumSelectorFactory } from '../../../src/modules/transactions/transactions.selectors.js';
...
describe('transactions selectors', () => {
    ...
    it('should return assigned transactions', () => {
        ...
        let assignedTransactions = assignedTransactionsSelectorFactory(itemKey)(state)
    ...
    it('should return the sum of assigned transactions', () => {
        ...
        let assignedTransactionsSum = assignedTransactionsSumSelectorFactory(itemKey)(state)
